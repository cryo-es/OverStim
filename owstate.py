...
class OverwatchStateTracker:
    def __init__(self):
        coords = {
            ...
            "baptiste_weapon": [969, 993, 1824, 1857],
            "brigitte_weapon": [954, 992, 1710, 1788],
            "kiriko_weapon": [959, 991, 1656, 1767],
            "lucio_weapon": [949, 993, 1716, 1762],
            ...
            "mercy_resurrect_cd": [920, 1000, 1580, 1655],
